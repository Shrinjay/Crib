...
from transform.transform_service import filter_by_time, filter_by_crime_type
from utils.crime_types import DROPPED_CRIMES
...
def insights_from_request(request, config: Config):
    ...
    crime_df = filter_by_crime_type(crime_df, DROPPED_CRIMES)
